...
3. The TopologyGeneration.m file is a MATLAB script to read the .xlsx files and generate the corresponding communication network topologies for each IEEE test power system;
